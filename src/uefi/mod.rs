...
/// whole batch over it. Confirmed live on vmsifter (a real QSP fuzzing run whose
...
impl UefiOsInfo {
        ...
        P: AsRef<Path>,
    {
        ...
        for (name, base, _size, embedded_path) in modules {
            ...
            // (vmsifter, real QSP boot): a real 67-module tracker_obj->maps
    ...
    P: AsRef<Path>,
{
    ...
    // live (vmsifter): a real 67-row `maps` converted this way parsed as 0 module
